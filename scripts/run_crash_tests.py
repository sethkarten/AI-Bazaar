...
CRASH_TESTS = [
    ...
    (
        ...
        [
            ...
            "--discovery-limit", "1", "--max-tokens", "2000", "--prompt-algo", "cot",
            "--no-diaries", "--seed", "8",
        ],
    ),
    (
        ...
        [
            ...
            "--max-timesteps", "50", "--firm-initial-cash", "1000",
            "--consumer-scenario", "THE_CRASH", "--llm", "gemini-2.5-flash",
            "--discovery-limit", "2", "--max-tokens", "2000", "--prompt-algo", "cot",
            "--no-diaries", "--seed", "8",
        ],
    ),
    (
        ...
        [
            ...
            "--max-timesteps", "50", "--firm-initial-cash", "1000",
            "--consumer-scenario", "THE_CRASH", "--llm", "gemini-2.5-flash",
            "--discovery-limit", "5", "--max-tokens", "2000", "--prompt-algo", "cot",
            "--no-diaries", "--seed", "8",
        ],
    ),
    (
        ...
        [
            ...
            "--max-timesteps", "50", "--firm-initial-cash", "1000",
            "--consumer-scenario", "THE_CRASH", "--llm", "gemini-2.5-flash",
            "--discovery-limit", "8", "--max-tokens", "2000", "--prompt-algo", "cot",
            "--no-diaries", "--seed", "8",
        ],
    ),
