"""
Shared cache utilities for Exp2 figure scripts.

Cache files are written to paper/fig/exp2/data/ as JSON.
...
def get_cache_path(data_dir, script_stem, good):
    """E.g. paper/fig/exp2/data/exp2_sybil_detection_food.json"""
