...
17 dense open-weight models run via OpenRouter (`scripts/exp1_eas_sweep.py`).
...
| Qwen3.5 9B       | 9.0        | `qwen/qwen3.5-9b`                                |
...
| GPT-OSS 120B     | 120.0      | `openai/gpt-oss-120b`                             |
...
| Llama 3.1 70B  | 70.0       | `meta-llama/llama-3.1-70b-instruct`           | Superseded by Llama 3.3   |
| Hermes 3 405B  | 405.0      | `nousresearch/hermes-3-llama-3.1-405b`        | Superseded by Hermes 4    |
